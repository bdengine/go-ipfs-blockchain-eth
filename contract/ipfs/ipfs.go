...
//
// Solidity: function addFile(string uid, string cid, uint256 size, uint256 blockNum) payable returns()
func (_Ipfs *IpfsTransactor) AddFile(opts *bind.TransactOpts, uid string, cid string, size *big.Int, blockNum *big.Int) (*types.Transaction, error) {
	return _Ipfs.contract.Transact(opts, "addFile", uid, cid, size, blockNum)
}

// AddFile is a paid mutator transaction binding the contract method 0x7f7847fe.
//
// Solidity: function addFile(string uid, string cid, uint256 size, uint256 blockNum) payable returns()
func (_Ipfs *IpfsSession) AddFile(uid string, cid string, size *big.Int, blockNum *big.Int) (*types.Transaction, error) {
	return _Ipfs.Contract.AddFile(&_Ipfs.TransactOpts, uid, cid, size, blockNum)
}

// AddFile is a paid mutator transaction binding the contract method 0x7f7847fe.
//
// Solidity: function addFile(string uid, string cid, uint256 size, uint256 blockNum) payable returns()
func (_Ipfs *IpfsTransactorSession) AddFile(uid string, cid string, size *big.Int, blockNum *big.Int) (*types.Transaction, error) {
	return _Ipfs.Contract.AddFile(&_Ipfs.TransactOpts, uid, cid, size, blockNum)
}
