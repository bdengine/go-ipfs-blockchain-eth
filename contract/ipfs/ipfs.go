...
//
// Solidity: function rechargeFile(string uid, string cid, uint256 wad) payable returns()
func (_Ipfs *IpfsTransactor) RechargeFile(opts *bind.TransactOpts, uid string, cid string, wad *big.Int) (*types.Transaction, error) {
	return _Ipfs.contract.Transact(opts, "rechargeFile", uid, cid, wad)
}

// RechargeFile is a paid mutator transaction binding the contract method 0x39429038.
//
// Solidity: function rechargeFile(string uid, string cid, uint256 wad) payable returns()
func (_Ipfs *IpfsSession) RechargeFile(uid string, cid string, wad *big.Int) (*types.Transaction, error) {
	return _Ipfs.Contract.RechargeFile(&_Ipfs.TransactOpts, uid, cid, wad)
}

// RechargeFile is a paid mutator transaction binding the contract method 0x39429038.
//
// Solidity: function rechargeFile(string uid, string cid, uint256 wad) payable returns()
func (_Ipfs *IpfsTransactorSession) RechargeFile(uid string, cid string, wad *big.Int) (*types.Transaction, error) {
	return _Ipfs.Contract.RechargeFile(&_Ipfs.TransactOpts, uid, cid, wad)
}
